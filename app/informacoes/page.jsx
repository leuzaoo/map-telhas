          ...
          <section className="mt-5">
            <ul className="flex flex-col md:flex-row md:flex-wrap gap-5 justify-between">
              ...
              <li className="hidden">
                ...
                <h3>
                  Com perfil em forma de trapézio, as telhas trapezoidais
                  oferecem robustez e eficiência estrutural, sendo ideais para
                  projetos que exigem resistência e desempenho.
                </h3>
              </li>
              <li className="hidden">
                <h2>Telhas Galvanizadas</h2>
                <h3>
                  Telhas galvanizadas são revestidas com uma camada de zinco
                  para proteção contra corrosão, oferecendo durabilidade e
                  resistência em ambientes desafiadores.
                </h3>
              </li>
              <li className="hidden">
              ...
              <li className="hidden">
                ...
                <h3>
                  Telhas com revestimento de Galvalume e núcleo isolante de
                  isopor proporcionam isolamento térmico e resistência à
                  corrosão, sendo ideais para uma variedade de aplicações.
                </h3>
              </li>
              <li className="hidden">
              ...
              <li className="hidden">
                ...
                <h3>
                  Nossa fábrica é especializada na produção de telhas metálicas
                  em diferentes modelos e especificações, garantindo soluções
                  sob medida para suas necessidades de cobertura.
                </h3>
              </li>
              <li className="hidden">
                ...
                <h3>
                  ...
                  revestimento de Galvalume, oferecendo durabilidade e
                  resistência superior para sua cobertura.
                </h3>
              </li>
              <li className="hidden">
              ...
              <li className="hidden">
                <h2>Telha Pintada</h2>
                <h3>
                  Telhas que passaram pelo processo de pintura para adicionar
                  cor e proteção à superfície, proporcionando durabilidade e
                  estética atraente.
                </h3>
              </li>
              <li className="hidden">
