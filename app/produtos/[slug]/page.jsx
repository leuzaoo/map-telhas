...
export default async function ProductPage({ params }) {
  ...
  return (
    <>
      <Center>
        <h1 className="mt-5 pb-5 text-[40px] font-semibold">{product.name}</h1>
        ...
        <footer className="pb-5 text-lg lg:text-xl">
          ...
          <p>
            Líder em soluções de telhas metálicas de qualidade excepcional. Com
            uma trajetória de 28 anos de excelência, nós estabelecemos como uma
            referência confiável e inovadora no setor.
          </p>
          <br />
          <p>
